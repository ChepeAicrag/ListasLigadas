...
public class CopyOfLinkedList implements Iterable
{ 
    Node head;
    ...
    private static CopyOfLinkedList insert(CopyOfLinkedList list, Animal data) { 
    ...
    private static void printList(CopyOfLinkedList list) 
    { 
        System.out.println("\nLinkedList: "); 
    ...
    static private Animal getForEach(CopyOfLinkedList list, String key) {
        for (Object obj : list) {
            Animal a = (Animal) obj;
    ...
    static private Animal getIterador(CopyOfLinkedList list, String key) {
    ...
    private static CopyOfLinkedList deleteByKey(CopyOfLinkedList list, String key) 
    { 
    ...
    private static CopyOfLinkedList deleteAtPosition(CopyOfLinkedList list, int index) 
    { 
        Node currNode = list.head, prev = null; 
    ...
    public static void main(String[] args) { 
        CopyOfLinkedList list = new CopyOfLinkedList(); 
        ...
        System.out.println("Jefa ->     "     + getRecursivo("Jefa", list.head));
        System.out.println("Pedrolo  -> " + getRecursivo("Pedrolo", list.head));
        System.out.println();
        
        System.out.println("Busqueda de un Animal x nombre usando un Iterador:");
        System.out.println("Peña ->     " + getIterador(list, "Peña"));
        System.out.println("Chino ->    " + getIterador(list, "Chino"));
        System.out.println();
        
        System.out.println("Busqueda de un Animal x nombre usando for-each:");
        System.out.println("Speedy ->   " + getForEach(list, "Speedy"));
        System.out.println("Rolix  ->   " + getForEach(list, "Rolix"));
